<template>
  <div class="space-y-6 w-full">
    ...
    <div class="mt-6">
      <button
        :disabled="isChecking"
        class="inline-flex items-center px-2.5 py-1.5 text-sm bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"

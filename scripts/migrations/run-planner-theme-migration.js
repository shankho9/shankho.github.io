 ...
 * Usage:
 *   Development: node scripts/migrations/run-planner-theme-migration.js
 *   Production: NODE_ENV=production node scripts/migrations/run-planner-theme-migration.js
 */
...
async function runMigration() {
  ...
  try {
    ...
    const migrationPath = join(process.cwd(), 'server/db/migrations/add_theme_to_tasks.sql')
    ...
    try {
      ...
      console.log('✅ Theme field added to tasks table with index')
    } finally {
      client.release()
    }

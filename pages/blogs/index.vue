...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Explore various blog posts on diverse topics except lifelines.',
    },
  ],
})
...
defineOgImage({
  title: 'Blog Posts',
  description: 'Explore various blog posts on diverse topics except lifelines.',
...
<template>
  <main class="container max-w-5xl mx-auto text-zinc-600">
    <ArchiveHero title="Blog Posts" description="Explore various blog posts on diverse topics." />

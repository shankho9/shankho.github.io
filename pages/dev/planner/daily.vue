  ...
  <div class="container mx-auto px-4 py-8">
    <div class="mb-6">
      <div class="flex items-center justify-between mb-4">
        <div>
          <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Daily Planner</h1>
        ...
        <div class="flex flex-col gap-3">
          <div class="flex items-center gap-3">
            ...
            <button
              ...
              class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors flex-shrink-0"

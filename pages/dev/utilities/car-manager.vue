...
import CarManager from '~/components/dev/CarManager.vue'
  ...
  <div class="container mx-auto px-3 sm:px-4 py-4 sm:py-8 max-w-full overflow-x-hidden">
    <div v-if="!isAuthenticated" class="max-w-md mx-auto">
      <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8 text-center">
        <h1 class="text-3xl font-bold mb-2">Car Database Manager</h1>
        <p class="text-gray-600 dark:text-gray-400 mb-6">Authentication required</p>
        <NuxtLink
          to="/auth/login?redirect=/dev/utilities/car-manager"
        ...
        >
          <div>
            ...
            <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400 mt-1">
              View, edit, and manage car manufacturers, models, and variants
            </p>
          </div>
          <NuxtLink
            to="/dev"

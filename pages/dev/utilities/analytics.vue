  ...
  <div class="container mx-auto px-3 sm:px-4 py-4 sm:py-8 max-w-full overflow-x-hidden">
    <div v-if="!isAuthenticated" class="max-w-md mx-auto">
      <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8 text-center">
        ...
        <NuxtLink
          to="/auth/login?redirect=/dev/utilities/analytics"
    ...
    <div v-else>
      ...
      <div class="mb-4 sm:mb-6">
        ...
        >
          ...
          <NuxtLink
            to="/dev"
            class="px-4 py-2 bg-gray-200 dark:bg-slate-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-300 dark:hover:bg-slate-600 transition-colors text-sm"
          >
            ← Back to Utilities
          </NuxtLink>
        </div>

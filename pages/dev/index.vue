            ...
            >
              <div class="flex items-center gap-3 mb-3">
                ...
                <div class="min-w-0">
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-400">Popular posts & engagement</p>
                </div>
              </div>
              <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
            ...
            >
              <div class="flex items-center gap-3 mb-3">
                ...
                <div class="min-w-0">
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-400">List from Location Manager</p>
                </div>
              </div>
              <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
            ...
            >
              <div class="flex items-center gap-3 mb-3">
                ...
                <div class="min-w-0">
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-400">Housing decision analysis</p>
                </div>
              </div>
              <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
            ...
            >
              <div class="flex items-center gap-3 mb-3">
                ...
                <div class="min-w-0">
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-400">Road vs flight comparison</p>
                </div>
              </div>
              <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
